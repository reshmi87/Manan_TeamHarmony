...
Background:
  ...
  Scenario Outline: Validating the Analysis report generated by the AI
    Given The user has input all the required information on the Assessment page
    When The user clicks the Analyze Case button
    Then The system displays an AI-generated Analysis report containing the following seven <SectionTitle> 
	Examples:
      | SectionTitle                                 |
      | Triage Level                                 |
