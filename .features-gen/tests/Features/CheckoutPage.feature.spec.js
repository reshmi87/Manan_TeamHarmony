...
test.describe('Checkout Page Validation', () => {
  ...
  test('Paying with Link', async ({ When, Then }) => { 
    ...
    await Then('A pop-up window should appear prompting the user to log in with their Email ID and proceed to the payment gateway with the Pay button enabled'); 
  });
  ...
  test('Completing the payment process', async ({ When, page, Then }) => { 
    await When('The user submits the payment form with valid credit card information', null, { page }); 
    await Then('A confirmation message should appear indicating successful payment', null, { page }); 
  });
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":49,"pickleLine":41,"tags":[],"steps":[{"pwStepLine":7,"gherkinStepLine":4,"keywordType":"Context","textWithKeyword":"Given The user is signed in and on the Checkout page","isBg":true,"stepMatchArguments":[]},{"pwStepLine":50,"gherkinStepLine":42,"keywordType":"Action","textWithKeyword":"When The user clicks the Subscribe button without entering cardholder Name","stepMatchArguments":[]},{"pwStepLine":51,"gherkinStepLine":43,"keywordType":"Outcome","textWithKeyword":"Then The user receives field validation error","stepMatchArguments":[]}]},
  {"pwTestLine":54,"pickleLine":45,"tags":[],"steps":[{"pwStepLine":7,"gherkinStepLine":4,"keywordType":"Context","textWithKeyword":"Given The user is signed in and on the Checkout page","isBg":true,"stepMatchArguments":[]},{"pwStepLine":55,"gherkinStepLine":46,"keywordType":"Action","textWithKeyword":"When The user clicks the Back arrow button","stepMatchArguments":[]},{"pwStepLine":56,"gherkinStepLine":47,"keywordType":"Outcome","textWithKeyword":"Then The user should be redirected to the subscription cancelled page with Go to Dashboard and View Subscription Plans buttons visible","stepMatchArguments":[]}]},
  {"pwTestLine":59,"pickleLine":49,"tags":[],"steps":[{"pwStepLine":7,"gherkinStepLine":4,"keywordType":"Context","textWithKeyword":"Given The user is signed in and on the Checkout page","isBg":true,"stepMatchArguments":[]},{"pwStepLine":60,"gherkinStepLine":50,"keywordType":"Action","textWithKeyword":"When The user unselects the Save my info for one-click checkout with Link option","stepMatchArguments":[]},{"pwStepLine":61,"gherkinStepLine":51,"keywordType":"Outcome","textWithKeyword":"Then The phone number input field should not be visible","stepMatchArguments":[]},{"pwStepLine":62,"gherkinStepLine":52,"keywordType":"Action","textWithKeyword":"When The user selects again the Save my info for one-click checkout with Link option","stepMatchArguments":[]},{"pwStepLine":63,"gherkinStepLine":53,"keywordType":"Outcome","textWithKeyword":"Then The phone number input field should be visible","stepMatchArguments":[]}]},
  {"pwTestLine":66,"pickleLine":55,"tags":[],"steps":[{"pwStepLine":7,"gherkinStepLine":4,"keywordType":"Context","textWithKeyword":"Given The user is signed in and on the Checkout page","isBg":true,"stepMatchArguments":[]},{"pwStepLine":67,"gherkinStepLine":56,"keywordType":"Action","textWithKeyword":"When The user enters a mobile number with a missing digit","stepMatchArguments":[]},{"pwStepLine":68,"gherkinStepLine":57,"keywordType":"Outcome","textWithKeyword":"Then An error message should appear indicating that the mobile number is incomplete","stepMatchArguments":[]},{"pwStepLine":69,"gherkinStepLine":58,"keywordType":"Action","textWithKeyword":"When The user enters a mobile number with extra digits","stepMatchArguments":[]},{"pwStepLine":70,"gherkinStepLine":59,"keywordType":"Outcome","textWithKeyword":"Then An error message should appear indicating the mobile number is invalid and to please ensure the correct country is selected in the dropdown","stepMatchArguments":[]}]},
  {"pwTestLine":73,"pickleLine":61,"tags":[],"steps":[{"pwStepLine":7,"gherkinStepLine":4,"keywordType":"Context","textWithKeyword":"Given The user is signed in and on the Checkout page","isBg":true,"stepMatchArguments":[]},{"pwStepLine":74,"gherkinStepLine":62,"keywordType":"Action","textWithKeyword":"When The user submits the payment form with valid credit card information","stepMatchArguments":[]},{"pwStepLine":75,"gherkinStepLine":63,"keywordType":"Outcome","textWithKeyword":"Then A confirmation message should appear indicating successful payment","stepMatchArguments":[]}]},
]; // bdd-data-end